...
def _process_utterance(audio_dir, label_dir, index, wav_path, text_path, args):
    ...
    Args:
        - audio_dir: the directory to write the mel spectograms into
        - label_dir: the directory to write the normalized texts into
        - index: the numeric index to use in the spectogram filename
        - wav_path: path to the audio file containing the speech input
        - textv_path: path to the text file containing the text input
        - args: hyper parameters

    Returns:
        - A tuple: (wav_path, text_path, mel_filename, label_filename, time_steps, mel_frames)
    """
    try:
