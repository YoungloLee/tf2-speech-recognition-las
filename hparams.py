...
def config2parser(model='LAS', data='train'):
	...
	parser.add_argument('--n_jobs', type=int, default=cpu_count() // 4)
	...
	# Hyper-parameters
	# Audio
	parser.add_argument('--num_mels', type=int, default=64, help='number of mel-spectrogram channels')
	...
	parser.add_argument('--win_size', type=int, default=320, help='for 16000, 320 ~= 20 ms (If None, win_size = n_fft)')
	...
	parser.add_argument('--drop_rate_rnn', type=float, default=0.2)
